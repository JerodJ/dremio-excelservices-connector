...
3. Download and install the [SharePoint Excel Services JDBC Driver from CData](https://www.cdata.com/drivers/excelservices/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:

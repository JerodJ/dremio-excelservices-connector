...
@SourceType(value = "ExcelServicesARP", label = "ExcelServices",uiConfig = "excelservices-layout.json")
public class ExcelServicesConf extends AbstractArpConf<ExcelServicesConf> {
  private static final String ARP_FILENAME = "arp/implementation/excelservices-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.excelservices.ExcelServicesDriver";
